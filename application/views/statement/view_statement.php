...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <table id="Table_01" width="600" border="0" cellpadding="0" cellspacing="0" class="maxwidth">
      ...
      <tr>
        <td align="center" bgcolor="#00ADEF"><table width="95%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><p style="font-family:Arial, Helvetica, sans-serif;font-size:12px; color:#FFFFFF" class="text">Dear Shakila Manawadu,<br>
              <br>
              <?=$body_copy->body?></p></td>
          </tr>
          <tr>
              ...
              <table border="0" cellspacing="0" cellpadding="0" align="left" class="col-3">
                <tr>
                  ...
                  <table width="300" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="20" align="left" valign="top" class="txt01"><strong style="font-family:Arial, Helvetica, sans-serif;font-size:12px; color:#444444"><?php if ($statement->country != "mrp") {?>
                      Air Miles Card
                <?php } else { ?>
                	My Rewards Points Account 
                <?php } ?>      
                      </strong></td>
                      <td height="20" align="left" valign="top" class="txt01"><span style="font-family:Arial, Helvetica, sans-serif;font-size:12px; color:#444444">: 2741000000024</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td width="170" height="15" align="left" valign="top" class="txt01"><span style="font-family:Arial, Helvetica, sans-serif;font-size:12px; color:#444444">: 01/08/2014 to 31/08/2014</span></td>
                    </tr>
                    <tr>
                      ...
                      <td height="15" align="left" valign="top" class="txt01"><span style="font-family:Arial, Helvetica, sans-serif;font-size:12px; color:#444444">: 400,928</span></td>
                    </tr>
                    <tr>
                      ...
                      <td height="15" align="left" valign="top" class="txt01"><span style="font-family:Arial, Helvetica, sans-serif;font-size:12px; color:#444444">: 2,301</span></td>
                    </tr>
                    <tr>
                      ...
                      <td height="15" align="left" valign="top" class="txt01"><span style="font-family:Arial, Helvetica, sans-serif;font-size:12px; color:#444444">: 1,000</span></td>
                    </tr>
                    <tr>
                      ...
                      <td height="15" align="left" valign="top" class="txt01"><span style="font-family:Arial, Helvetica, sans-serif;font-size:12px; color:#444444">: 2,000</span></td>
                    </tr>
                    <tr>
                      ...
                      <td height="15" align="left" valign="top" class="txt01"><span style="font-family:Arial, Helvetica, sans-serif;font-size:12px; color:#444444">: 380,000</span></td>
                    </tr>
                    <tr>
 ...
 31 / 03 / <?=$year?></strong></td>
                      <td height="20" align="left" valign="top" class="txt01"><span style="font-family:Arial, Helvetica, sans-serif;font-size:12px; color:#444444"> : 100</span></td>
                    </tr>
                    <tr>
                      ...
                      <?php } ?>
                            ...
                            <ul type="square" >
                              ...
                              <a href="http://www.airmilesme.com/en-<?=$statement->country?>/article/about-us/air-miles-expiry-policy.html#3years" style="color:#444444; text-decoration:none">Three Year Air Miles Expiry Policy</a>
                               <?php } else { ?>
                             <a href="          
http://[EMV FIELD]PT_DESC_3[EMV /FIELD].myrewardspoints.com/en/points-expiry/#years" target="_blank" style="color:#444444; text-decoration:none">Three Year Rewards Points Expiry Policy</a>
                              <?php } ?>
                             </li>
                              <li style="font-family:Arial, Helvetica, sans-serif;font-size:10px; margin:0px;">
                              <?php if ($statement->country != "mrp") { ?>
                              ...
                              <?php } else { ?>
                              <a href="
http://[EMV FIELD]PT_DESC_3[EMV /FIELD].myrewardspoints.com/en/points-expiry/#months" target="_blank" style="color:#444444; text-decoration:none">Fifteen Month Inactive Account Closure Policy</a>
                              <?php } ?>
                              </li>
                            </ul></td>
                    </tr>
              ...
              <table border="0" cellspacing="0" cellpadding="0" align="center" class="last-col-3" width="100%">
                <tr>
                  <td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                      <td align="center" bgcolor="#159854"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="125" align="center" valign="middle"><strong style="font-family:Arial,Helvetica,sans-serif;font-size:19px;color:#fff">ACCOUNT ACTIVE</strong><br><br><span style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#fff;text-decoration:none"> Continue to collect Air Miles at our partners and turn your everyday shopping into rewards.</span></td>
                        </tr>
                      </table></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <a href="http://[EMV FIELD]PT_DESC_3[EMV /FIELD].myrewardspoints.com/en/my-account/view-my-statement/" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#FFF; text-decoration:none">View My Account</a>
...
<span style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#F00; text-decoration:none" class="text_offer">Read More</span></a>
            ...
            <td align="right" valign="top" class="force-col">
